...
public class CytrusStairsBlock extends HaileymodModElements.ModElement {
	@ObjectHolder("haileymod:cytrus_stairs")
	public static final Block block = null;
	public CytrusStairsBlock(HaileymodModElements instance) {
		super(instance, 26);
	}
