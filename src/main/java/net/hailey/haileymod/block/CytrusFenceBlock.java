...
public class CytrusFenceBlock extends HaileymodModElements.ModElement {
	@ObjectHolder("haileymod:cytrus_fence")
	public static final Block block = null;
	public CytrusFenceBlock(HaileymodModElements instance) {
		super(instance, 28);
	}
