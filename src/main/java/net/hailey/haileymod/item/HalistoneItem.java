...
public class HalistoneItem extends HaileymodModElements.ModElement {
	@ObjectHolder("haileymod:hardened_halistone")
	public static final Item block = null;
	public HalistoneItem(HaileymodModElements instance) {
		super(instance, 38);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("hardened_halistone");
		}
